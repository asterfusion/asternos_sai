...
typedef enum _sai_vlan_stack_attr_t
{
    ...
    /**
     * @brief The packet TC (3 bits) in the vlan tag
     * Range from 0 to 7.
     * Default 0xFF will inherit the port's default TC.
     *
     * @type sai_uint8_t
     * @flags CREATE_AND_SET
     * @default 0xFF
     */
    SAI_VLAN_STACK_ATTR_CUSTOM_REMARK_TC,

    /**
     * @brief The upstream port list for untagged vlan stack
     *
     ...
     * @default empty
     */
    SAI_VLAN_STACK_ATTR_CUSTOM_UPSTREAM_PORT_LIST,
