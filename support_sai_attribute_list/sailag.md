...
| --- | --- | --- | --- | --- |
| create_lag | SAI_LAG_ATTR_INGRESS_ACL |  | yes |  |
...
|  | SAI_LAG_ATTR_TPID |  | yes |  |
|  | SAI_LAG_ATTR_SYSTEM_PORT_AGGREGATE_ID |  | yes |  |
|  | SAI_LAG_ATTR_LABEL |  | yes |  |
|  | SAI_LAG_ATTR_ARS_OBJECT_ID |  | yes |  |
|  | SAI_LAG_ATTR_CUSTOM_ISOLATION_GROUP |  | yes | yes |
| remove_lag |  |  | yes |  |
...
|  | SAI_LAG_ATTR_LABEL |  | yes |  |
|  | SAI_LAG_ATTR_ARS_OBJECT_ID |  | yes |  |
|  | SAI_LAG_ATTR_ARS_PACKET_DROPS |  | yes |  |
|  | SAI_LAG_ATTR_ARS_PORT_REASSIGNMENTS |  | yes |  |
|  | SAI_LAG_ATTR_CUSTOM_ISOLATION_GROUP |  | yes | yes |
