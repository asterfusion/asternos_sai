...
| --- | --- | --- | --- | --- |
| create_isolation_group | SAI_ISOLATION_GROUP_ATTR_TYPE | SAI_ISOLATION_GROUP_TYPE_PORT | yes |  |
|  |  | SAI_ISOLATION_GROUP_TYPE_BRIDGE_PORT | yes |  |
|  | SAI_ISOLATION_GROUP_ATTR_ISOLATION_MEMBER_LIST |  | yes |  |
| remove_isolation_group |  |  | yes |  |
| set_isolation_group_attribute |  |  | yes |  |
...
| set_isolation_group_member_attribute |  |  | yes |  |
