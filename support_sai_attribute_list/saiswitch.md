...
| --- | --- | --- | --- | --- |
| create_switch | SAI_SWITCH_ATTR_INGRESS_ACL            |  | no |  |
|  | SAI_SWITCH_ATTR_EGRESS_ACL             |  | no |  |
|  | SAI_SWITCH_ATTR_RESTART_WARM           |  | no |  |
|  | SAI_SWITCH_ATTR_WARM_RECOVER           |  | no |  |
|  | SAI_SWITCH_ATTR_SWITCHING_MODE         | SAI_SWITCH_SWITCHING_MODE_CUT_THROUGH | no |  |
|  |  | SAI_SWITCH_SWITCHING_MODE_STORE_AND_FORWARD | no |  |
|  | SAI_SWITCH_ATTR_BCAST_CPU_FLOOD_ENABLE |  | no |  |
|  | SAI_SWITCH_ATTR_MCAST_CPU_FLOOD_ENABLE |  | no |  |
|  | SAI_SWITCH_ATTR_SRC_MAC_ADDRESS        |  | no |  |
|  | SAI_SWITCH_ATTR_MAX_LEARNED_ADDRESSES  |  | no |  |
|  | SAI_SWITCH_ATTR_FDB_AGING_TIME         |  | no |  |
...
|  | SAI_SWITCH_ATTR_FDB_BROADCAST_MISS_PACKET_ACTION | SAI_PACKET_ACTION_DROP | yes |  |
|  |  | SAI_PACKET_ACTION_FORWARD | yes |  |
|  |  | SAI_PACKET_ACTION_COPY | yes |  |
|  |  | SAI_PACKET_ACTION_COPY_CANCEL | no |  |
|  |  | SAI_PACKET_ACTION_TRAP | yes |  |
...
|  |  | SAI_PACKET_ACTION_DONOTDROP | no |  |
|  |  | SAI_PACKET_ACTION_REMARK | no |  |
|  | SAI_SWITCH_ATTR_FDB_MULTICAST_MISS_PACKET_ACTION | SAI_PACKET_ACTION_DROP | yes |  |
|  |  | SAI_PACKET_ACTION_FORWARD | yes |  |
|  |  | SAI_PACKET_ACTION_COPY | yes |  |
|  |  | SAI_PACKET_ACTION_COPY_CANCEL | no |  |
|  |  | SAI_PACKET_ACTION_TRAP | yes |  |
...
|  |  | SAI_PACKET_ACTION_DONOTDROP | no |  |
|  |  | SAI_PACKET_ACTION_REMARK | no |  |
|  | SAI_SWITCH_ATTR_ECMP_DEFAULT_HASH_ALGORITHM | SAI_HASH_ALGORITHM_CRC | no |  |
...
|  | SAI_SWITCH_ATTR_ECMP_DEFAULT_HASH_SEED |  | no |  |
|  | SAI_SWITCH_ATTR_ECMP_DEFAULT_HASH_OFFSET |  | no |  |
|  | SAI_SWITCH_ATTR_ECMP_DEFAULT_SYMMETRIC_HASH |  | no |  |
|  | SAI_SWITCH_ATTR_ECMP_HASH_IPV4         |  | no |  |
|  | SAI_SWITCH_ATTR_ECMP_HASH_IPV4_IN_IPV4 |  | no |  |
|  | SAI_SWITCH_ATTR_ECMP_HASH_IPV6         |  | no |  |
|  | SAI_SWITCH_ATTR_LAG_DEFAULT_HASH_ALGORITHM |  | no |  |
|  | SAI_SWITCH_ATTR_LAG_DEFAULT_HASH_SEED  |  | no |  |
|  | SAI_SWITCH_ATTR_LAG_DEFAULT_HASH_OFFSET |  | no |  |
|  | SAI_SWITCH_ATTR_LAG_DEFAULT_SYMMETRIC_HASH |  | no |  |
|  | SAI_SWITCH_ATTR_LAG_HASH_IPV4          |  | no |  |
|  | SAI_SWITCH_ATTR_LAG_HASH_IPV4_IN_IPV4  |  | no |  |
|  | SAI_SWITCH_ATTR_LAG_HASH_IPV6          |  | no |  |
|  | SAI_SWITCH_ATTR_COUNTER_REFRESH_INTERVAL |  | no |  |
|  | SAI_SWITCH_ATTR_QOS_DEFAULT_TC         |  | no |  |
|  | SAI_SWITCH_ATTR_QOS_DOT1P_TO_TC_MAP    |  | no |  |
|  | SAI_SWITCH_ATTR_QOS_DOT1P_TO_COLOR_MAP |  | no |  |
|  | SAI_SWITCH_ATTR_QOS_DSCP_TO_TC_MAP     |  | no |  |
|  | SAI_SWITCH_ATTR_QOS_DSCP_TO_COLOR_MAP  |  | no |  |
|  | SAI_SWITCH_ATTR_QOS_TC_TO_QUEUE_MAP    |  | no |  |
|  | SAI_SWITCH_ATTR_QOS_TC_AND_COLOR_TO_DOT1P_MAP |  | no |  |
|  | SAI_SWITCH_ATTR_QOS_TC_AND_COLOR_TO_DSCP_MAP |  | no |  |
|  | SAI_SWITCH_ATTR_SWITCH_SHELL_ENABLE    |  | no |  |
...
|  | SAI_SWITCH_ATTR_SWITCH_STATE_CHANGE_NOTIFY |  | no |  |
|  | SAI_SWITCH_ATTR_SWITCH_SHUTDOWN_REQUEST_NOTIFY |  | no |  |
|  | SAI_SWITCH_ATTR_SHUTDOWN_REQUEST_NOTIFY |  | no |  |
|  | SAI_SWITCH_ATTR_FDB_EVENT_NOTIFY       |  | no |  |
|  | SAI_SWITCH_ATTR_PORT_STATE_CHANGE_NOTIFY |  | no |  |
|  | SAI_SWITCH_ATTR_PACKET_EVENT_NOTIFY    |  | no |  |
...
| remove_switch | SAI_SWITCH_ATTR_NUMBER_OF_ACTIVE_PORTS |  | no |  |
| set_switch_attribute | SAI_SWITCH_ATTR_INGRESS_ACL            |  | no |  |
|  | SAI_SWITCH_ATTR_EGRESS_ACL             |  | no |  |
|  | SAI_SWITCH_ATTR_RESTART_WARM           |  | no |  |
|  | SAI_SWITCH_ATTR_WARM_RECOVER           |  | no |  |
|  | SAI_SWITCH_ATTR_SWITCHING_MODE         | SAI_SWITCH_SWITCHING_MODE_CUT_THROUGH | no |  |
...
|  | SAI_SWITCH_ATTR_CUSTOM_SNP4_ENTRY      |  | yes | yes |
|  | SAI_SWITCH_ATTR_CUSTOM_SNP6_ENTRY      |  | yes | yes |
| get_switch_attribute | SAI_SWITCH_ATTR_NUMBER_OF_ACTIVE_PORTS |  | no |  |
|  | SAI_SWITCH_ATTR_PORT_NUMBER |  | no |  |
|  | SAI_SWITCH_ATTR_MAX_NUMBER_OF_SUPPORTED_PORTS |  | no |  |
|  | SAI_SWITCH_ATTR_PORT_LIST |  | no |  |
|  | SAI_SWITCH_ATTR_PORT_MAX_MTU |  | no |  |
|  | SAI_SWITCH_ATTR_CPU_PORT               |  | no |  |
|  | SAI_SWITCH_ATTR_MAX_VIRTUAL_ROUTERS    |  | no |  |
|  | SAI_SWITCH_ATTR_FDB_TABLE_SIZE         |  | no |  |
|  | SAI_SWITCH_ATTR_L3_NEIGHBOR_TABLE_SIZE |  | no |  |
|  | SAI_SWITCH_ATTR_L3_ROUTE_TABLE_SIZE    |  | no |  |
|  | SAI_SWITCH_ATTR_LAG_MEMBERS            |  | no |  |
|  | SAI_SWITCH_ATTR_NUMBER_OF_LAGS         |  | no |  |
|  | SAI_SWITCH_ATTR_ECMP_MEMBERS           |  | no |  |
|  | SAI_SWITCH_ATTR_NUMBER_OF_ECMP_GROUPS  |  | no |  |
|  | SAI_SWITCH_ATTR_NUMBER_OF_UNICAST_QUEUES |  | no |  |
|  | SAI_SWITCH_ATTR_NUMBER_OF_MULTICAST_QUEUES |  | no |  |
|  | SAI_SWITCH_ATTR_NUMBER_OF_QUEUES       |  | no |  |
|  | SAI_SWITCH_ATTR_NUMBER_OF_CPU_QUEUES   |  | no |  |
|  | SAI_SWITCH_ATTR_ON_LINK_ROUTE_SUPPORTED |  | no |  |
|  | SAI_SWITCH_ATTR_OPER_STATUS            |  | no |  |
|  | SAI_SWITCH_ATTR_MAX_NUMBER_OF_TEMP_SENSORS |  | no |  |
|  | SAI_SWITCH_ATTR_TEMP_LIST              |  | no |  |
|  | SAI_SWITCH_ATTR_MAX_TEMP               |  | no |  |
|  | SAI_SWITCH_ATTR_AVERAGE_TEMP           |  | no |  |
|  | SAI_SWITCH_ATTR_ACL_TABLE_MINIMUM_PRIORITY |  | no |  |
|  | SAI_SWITCH_ATTR_ACL_TABLE_MAXIMUM_PRIORITY |  | no |  |
|  | SAI_SWITCH_ATTR_ACL_ENTRY_MINIMUM_PRIORITY |  | no |  |
|  | SAI_SWITCH_ATTR_ACL_ENTRY_MAXIMUM_PRIORITY |  | no |  |
...
|  | SAI_SWITCH_ATTR_ACL_USER_TRAP_ID_RANGE |  | no |  |
|  | SAI_SWITCH_ATTR_DEFAULT_VLAN_ID        |  | no |  |
|  | SAI_SWITCH_ATTR_DEFAULT_STP_INST_ID    |  | no |  |
|  | SAI_SWITCH_ATTR_MAX_STP_INSTANCE       |  | no |  |
|  | SAI_SWITCH_ATTR_DEFAULT_VIRTUAL_ROUTER_ID |  | no |  |
|  | SAI_SWITCH_ATTR_DEFAULT_OVERRIDE_VIRTUAL_ROUTER_ID |  | no |  |
|  | SAI_SWITCH_ATTR_DEFAULT_1Q_BRIDGE_ID   |  | no |  |
|  | SAI_SWITCH_ATTR_INGRESS_ACL            |  | no |  |
|  | SAI_SWITCH_ATTR_EGRESS_ACL             |  | no |  |
|  | SAI_SWITCH_ATTR_QOS_MAX_NUMBER_OF_TRAFFIC_CLASSES |  | no |  |
|  | SAI_SWITCH_ATTR_QOS_MAX_NUMBER_OF_SCHEDULER_GROUP_HIERARCHY_LEVELS |  | no |  |
|  | SAI_SWITCH_ATTR_QOS_MAX_NUMBER_OF_SCHEDULER_GROUPS_PER_HIERARCHY_LEVEL |  | no |  |
|  | SAI_SWITCH_ATTR_QOS_MAX_NUMBER_OF_CHILDS_PER_SCHEDULER_GROUP |  | no |  |
|  | SAI_SWITCH_ATTR_TOTAL_BUFFER_SIZE      |  | no |  |
|  | SAI_SWITCH_ATTR_INGRESS_BUFFER_POOL_NUM |  | no |  |
|  | SAI_SWITCH_ATTR_EGRESS_BUFFER_POOL_NUM |  | no |  |
|  | SAI_SWITCH_ATTR_AVAILABLE_IPV4_ROUTE_ENTRY |  | no |  |
|  | SAI_SWITCH_ATTR_AVAILABLE_IPV6_ROUTE_ENTRY |  | no |  |
|  | SAI_SWITCH_ATTR_AVAILABLE_IPV4_NEXTHOP_ENTRY |  | no |  |
|  | SAI_SWITCH_ATTR_AVAILABLE_IPV6_NEXTHOP_ENTRY |  | no |  |
|  | SAI_SWITCH_ATTR_AVAILABLE_IPV4_NEIGHBOR_ENTRY |  | no |  |
|  | SAI_SWITCH_ATTR_AVAILABLE_IPV6_NEIGHBOR_ENTRY |  | no |  |
|  | SAI_SWITCH_ATTR_AVAILABLE_NEXT_HOP_GROUP_ENTRY |  | no |  |
|  | SAI_SWITCH_ATTR_AVAILABLE_NEXT_HOP_GROUP_MEMBER_ENTRY |  | no |  |
|  | SAI_SWITCH_ATTR_AVAILABLE_FDB_ENTRY    |  | no |  |
...
|  | SAI_SWITCH_ATTR_AVAILABLE_ACL_TABLE    |  | no |  |
|  | SAI_SWITCH_ATTR_AVAILABLE_ACL_TABLE_GROUP |  | no |  |
|  | SAI_SWITCH_ATTR_AVAILABLE_MY_SID_ENTRY |  | no |  |
|  | SAI_SWITCH_ATTR_DEFAULT_TRAP_GROUP     |  | no |  |
|  | SAI_SWITCH_ATTR_ECMP_HASH              |  | no |  |
|  | SAI_SWITCH_ATTR_LAG_HASH               |  | no |  |
|  | SAI_SWITCH_ATTR_RESTART_WARM           |  | no |  |
|  | SAI_SWITCH_ATTR_WARM_RECOVER           |  | no |  |
|  | SAI_SWITCH_ATTR_RESTART_TYPE           |  | no |  |
|  | SAI_SWITCH_ATTR_MIN_PLANNED_RESTART_INTERVAL |  | no |  |
|  | SAI_SWITCH_ATTR_NV_STORAGE_SIZE        |  | no |  |
|  | SAI_SWITCH_ATTR_MAX_ACL_ACTION_COUNT   |  | no |  |
|  | SAI_SWITCH_ATTR_MAX_ACL_RANGE_COUNT    |  | no |  |
|  | SAI_SWITCH_ATTR_ACL_CAPABILITY         |  | no |  |
|  | SAI_SWITCH_ATTR_MCAST_SNOOPING_CAPABILITY |  | no |  |
|  | SAI_SWITCH_ATTR_SWITCHING_MODE         |  | no |  |
|  | SAI_SWITCH_ATTR_BCAST_CPU_FLOOD_ENABLE |  | no |  |
|  | SAI_SWITCH_ATTR_MCAST_CPU_FLOOD_ENABLE |  | no |  |
|  | SAI_SWITCH_ATTR_SRC_MAC_ADDRESS        |  | no |  |
|  | SAI_SWITCH_ATTR_MAX_LEARNED_ADDRESSES  |  | no |  |
|  | SAI_SWITCH_ATTR_FDB_AGING_TIME         |  | no |  |
|  | SAI_SWITCH_ATTR_FDB_UNICAST_MISS_PACKET_ACTION |  | no |  |
|  | SAI_SWITCH_ATTR_FDB_BROADCAST_MISS_PACKET_ACTION |  | no |  |
|  | SAI_SWITCH_ATTR_FDB_MULTICAST_MISS_PACKET_ACTION |  | no |  |
|  | SAI_SWITCH_ATTR_ECMP_DEFAULT_HASH_ALGORITHM |  | no |  |
|  | SAI_SWITCH_ATTR_ECMP_DEFAULT_HASH_SEED |  | no |  |
|  | SAI_SWITCH_ATTR_ECMP_DEFAULT_HASH_OFFSET |  | no |  |
|  | SAI_SWITCH_ATTR_ECMP_DEFAULT_SYMMETRIC_HASH |  | no |  |
|  | SAI_SWITCH_ATTR_ECMP_HASH_IPV4         |  | no |  |
...
|  | SAI_SWITCH_ATTR_FAST_API_ENABLE        |  | no |  |
|  | SAI_SWITCH_ATTR_MIRROR_TC              |  | no |  |
|  | SAI_SWITCH_ATTR_ACL_STAGE_INGRESS      |  | no |  |
|  | SAI_SWITCH_ATTR_ACL_STAGE_EGRESS       |  | no |  |
|  | SAI_SWITCH_ATTR_SRV6_MAX_SID_DEPTH     |  | no |  |
|  | SAI_SWITCH_ATTR_SRV6_TLV_TYPE          |  | no |  |
|  | SAI_SWITCH_ATTR_QOS_NUM_LOSSLESS_QUEUES |  | no |  |
|  | SAI_SWITCH_ATTR_QUEUE_PFC_DEADLOCK_NOTIFY |  | no |  |
